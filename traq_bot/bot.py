...
class TraqBot:
    ...
    def _register_function(
        self, func: Callable[[Optional[Dict]], None], event: str
    ) -> None:
        self._handlers[event].append(func)

    def ping(
        self, func: Callable[[Optional[Dict]], None]
    ...
    def bot_message_stamps_updated(
        self, func: Callable[[Optional[Dict]], None]
    ) -> Callable[[Optional[Dict]], None]:
    ...
    def __init__(self, port: int, bot: TraqBot):
        ...
        class TraqBotHandler(SimpleHTTPRequestHandler):
            def do_POST(self) -> None:
                ...
                verification_token: Optional[str] = self.headers.get("X-TRAQ-BOT-TOKEN")
            ...
            def _send_response(
                self, status: int, headers: Dict, body: Union[str, Dict]
            ) -> None:
        ...
        self._server: HTTPServer = HTTPServer(("0.0.0.0", self._port), TraqBotHandler)
